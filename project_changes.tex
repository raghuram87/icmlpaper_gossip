...
\icmltitlerunning{Efficient Gossip-based algorithm for aggregate function computation}

\begin{document} 

\twocolumn[
\icmltitle{An efficient Gossip-based algorithm to compute aggregation functions in a network}

% It is OKAY to include author information, even for blind
% submissions: the style file will automatically remove it for you
% unless you've provided the [accepted] option to the icml2013
% package.
\icmlauthor{Raghuram Nagireddy}{rrn2111@columbia.edu}
\icmladdress{Columbia University,
            New York, NY}
\icmlauthor{Haimonti Dutta}{haimonti@ccls.columbia.edu}
\icmladdress{Columbia University,
            New York, NY}
